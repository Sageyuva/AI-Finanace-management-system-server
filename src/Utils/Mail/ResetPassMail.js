...
const ResetPassMail = async (to, name, resetLink) => {
...
<head>
  <meta charset="UTF-8" />
  <title>Reset Your Finura Password</title>
</head>
        ...
        <table width="100%" max-width="520" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="padding-top:18px; text-align:center; font-size:15px; color:#CBD5F5; line-height:1.6;">
              If you initiated this request, please click the button below to
              <span style="color:#8B5CF6; font-weight:600;">securely reset your password</span>.
              <br/>This link will expire soon for security reasons.
            </td>
          </tr>
          ...
          <tr>
            <td style="padding-top:20px; text-align:center; font-size:13px; color:#94A3B8;">
              ...
              <br/>Your account remains secure.
            </td>
          </tr>
