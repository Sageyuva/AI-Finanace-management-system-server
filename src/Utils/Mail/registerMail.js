          ...
          <table width="100%" max-width="520" cellpadding="0" cellspacing="0" 
            ...
            <tr>
              <td style="padding-top:16px; text-align:center; font-size:16px; color:#94A3B8;">
                ...
                <br/>Welcome to the future of smart finance.
              </td>
            </tr>
            ...
            <tr>
              <td style="padding-top:18px; text-align:center; font-size:15px; color:#CBD5F5; line-height:1.6;">
                Please confirm your email address to activate your Finura account and unlock
                <span style="color:#8B5CF6; font-weight:600;">AI-powered insights</span>, 
                smart budgets & savings automation.
              </td>
            </tr>
            ...
            <tr>
              <td style="padding-top:20px; text-align:center; font-size:13px; color:#94A3B8;">
                If you didn’t create a Finura account, you can safely ignore this email.
              </td>
            </tr>
